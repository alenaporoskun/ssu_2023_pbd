...
fn_csv_in_zip = ["oil-prices.csv", "population.csv", "ppp.csv"]
...
def main():
    ...
    files_ppp = os.listdir('./data/ppp-master/data/')

    # os.path.join(src_dir, zip_file),
    p1 = './data/oil-prices-master/data/'
    p2 = files_oil[3]
    print('\n\n', os.path.join('oil-prices-master/data', 'brent-daily.csv'), '\n\n')

    print('\n\n', os.path.join('oil-prices-master/data', 'brent-daily.csv'), '\n\n')

    print("files_oil = os.listdir('./data/oil-prices-master/data/')")
    print('files_oil:\n', files_oil, '\n')

    data_list = read_test_csv_list(dst_dir, fn1)
    # print("data_list:", data_list)
    print("data_list:[0]", data_list[0])
    print("data_list:[1]", data_list[1])
    print("data_list[1][0]:", data_list[1][0], '\n')
    ...
    data_dict = read_test_csv_dict(dst_dir, fn1)
    print("data_dict[0]:", data_dict[0])
    print("data_dict[1]:", data_dict[1])
    #print("data_dict[1]['Year']):", data_dict[1]['Year'])
    ...
    #
    # data_json, filename_json = convert_csv_to_json(dst_dir, fn1)
    # #print("json:", data_json)
    # print("json filename:", filename_json)
    #
